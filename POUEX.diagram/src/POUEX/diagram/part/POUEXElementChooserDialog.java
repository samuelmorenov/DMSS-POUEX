 ...
 * @generated
 */
public class POUEXElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public POUEXElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.POUEXElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "POUEX".equals(fileExtension); //$NON-NLS-1$
	}
