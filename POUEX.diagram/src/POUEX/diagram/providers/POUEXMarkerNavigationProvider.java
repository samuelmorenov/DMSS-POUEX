...
import POUEX.diagram.part.POUEXDiagramEditorUtil;

/**
 * @generated
 */
public class POUEXMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = POUEXDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			POUEXDiagramEditorUtil.selectElementsInDiagram(editor,
