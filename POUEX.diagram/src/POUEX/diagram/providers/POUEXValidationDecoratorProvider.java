 ...
 * @generated
 */
public class POUEXValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = POUEXDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof POUEXDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& MascotaEditPart.MODEL_ID.equals(POUEXVisualIDRegistry
						.getModelID(view));
	}
