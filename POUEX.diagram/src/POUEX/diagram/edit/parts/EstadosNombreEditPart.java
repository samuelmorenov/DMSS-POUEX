 ...
 * @generated
 */
public class EstadosNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EstadosNombreEditPart(View view) {
		super(view);
	}
			...
			parser = POUEXParserProvider
					.getParser(
							...
							POUEXVisualIDRegistry
									.getType(POUEX.diagram.edit.parts.EstadosNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
