 ...
 * @generated
 */
public class CaracteristicasNombreEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CaracteristicasNombreEditPart(View view) {
		super(view);
	}
			...
			parser = POUEXParserProvider
					.getParser(
							...
							POUEXVisualIDRegistry
									.getType(POUEX.diagram.edit.parts.CaracteristicasNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
