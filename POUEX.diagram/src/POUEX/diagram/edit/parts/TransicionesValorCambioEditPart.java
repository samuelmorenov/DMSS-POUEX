...
import POUEX.diagram.edit.policies.POUEXTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TransicionesValorCambioEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				POUEXVisualIDRegistry
						.getType(POUEX.diagram.edit.parts.TransicionesValorCambioEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public TransicionesValorCambioEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new POUEXTextSelectionEditPolicy());
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					POUEXEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected IFigure createFigurePrim() {
		return new TransicionesLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TransicionesLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TransicionesLabelFigure() {
			this.setText("Transiciones");
		}
