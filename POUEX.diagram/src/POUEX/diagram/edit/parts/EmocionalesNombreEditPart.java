 ...
 * @generated
 */
public class EmocionalesNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EmocionalesNombreEditPart(View view) {
		super(view);
	}
			...
			parser = POUEXParserProvider
					.getParser(
							...
							POUEXVisualIDRegistry
									.getType(POUEX.diagram.edit.parts.EmocionalesNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
