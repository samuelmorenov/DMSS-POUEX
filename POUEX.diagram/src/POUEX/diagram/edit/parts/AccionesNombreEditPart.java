 ...
 * @generated
 */
public class AccionesNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AccionesNombreEditPart(View view) {
		super(view);
	}
	...
	protected Image getLabelIcon() {
		...
		return POUEXElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = POUEXParserProvider
					.getParser(
							POUEXElementTypes.Acciones_2005,
							getParserElement(),
							POUEXVisualIDRegistry
									.getType(POUEX.diagram.edit.parts.AccionesNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
