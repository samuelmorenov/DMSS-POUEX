 ...
 * @generated
 */
public class CriticosNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CriticosNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = POUEXParserProvider
					.getParser(
							POUEXElementTypes.Criticos_2004,
							getParserElement(),
							POUEXVisualIDRegistry
									.getType(POUEX.diagram.edit.parts.CriticosNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
