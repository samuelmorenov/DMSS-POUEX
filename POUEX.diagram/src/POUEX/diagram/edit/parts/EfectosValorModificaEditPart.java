 ...
 * @generated
 */
public class EfectosValorModificaEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				POUEXVisualIDRegistry
						.getType(POUEX.diagram.edit.parts.EfectosValorModificaEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public EfectosValorModificaEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new EfectosLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EfectosLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EfectosLabelFigure() {
			this.setText("Efectos");
		}
