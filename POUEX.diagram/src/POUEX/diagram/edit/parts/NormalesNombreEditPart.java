 ...
 * @generated
 */
public class NormalesNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NormalesNombreEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = POUEXParserProvider
					.getParser(
							POUEXElementTypes.Normales_2003,
							getParserElement(),
							POUEXVisualIDRegistry
									.getType(POUEX.diagram.edit.parts.NormalesNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
