 ...
 * @generated
 */
public class FisicasNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FisicasNombreEditPart(View view) {
		super(view);
	}
			...
			parser = POUEXParserProvider
					.getParser(
							...
							POUEXVisualIDRegistry
									.getType(POUEX.diagram.edit.parts.FisicasNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
