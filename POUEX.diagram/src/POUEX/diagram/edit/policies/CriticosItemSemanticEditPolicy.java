 ...
 * @generated
 */
public class CriticosItemSemanticEditPolicy extends
		POUEXBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public CriticosItemSemanticEditPolicy() {
		super(POUEXElementTypes.Criticos_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (POUEXVisualIDRegistry.getVisualID(incomingLink) == TransicionesEditPart.VISUAL_ID) {
