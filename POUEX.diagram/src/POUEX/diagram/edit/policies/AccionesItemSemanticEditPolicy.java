 ...
 * @generated
 */
public class AccionesItemSemanticEditPolicy extends
		POUEXBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public AccionesItemSemanticEditPolicy() {
		super(POUEXElementTypes.Acciones_2005);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (POUEXVisualIDRegistry.getVisualID(outgoingLink) == EfectosEditPart.VISUAL_ID) {
